...
$.getScript('https://cdnjs.cloudflare.com/ajax/libs/simple-peer/8.1.1/simplepeer.min.js', function() {

    var receiver = new SimplePeer({
        trickle: false
    });
...
// });
    ...
    receiver.on('stream', function (stream) {
        ...
        // capture = createVideo(window.URL.createObjectURL(stream));
    });
